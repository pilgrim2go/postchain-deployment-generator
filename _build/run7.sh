...
/opt/postchain-node/postchain.sh peerinfo-add -h node7 -nc /usr/src/rell/config/node-config.properties -p 9870 -pk 03C77144C526C87032B8168801124BF7761E90AFCFB33368683721F423BFE37031
