...
/opt/postchain-node/postchain.sh peerinfo-add -h node1 -nc /usr/src/rell/config/node-config.properties -p 9870 -pk 037E64CA1BDB0D22C93A4757B09449C5CB04441E69CEDBCD8F30FC7DD62625791B
