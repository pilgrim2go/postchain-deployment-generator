...
/opt/postchain-node/postchain.sh peerinfo-add -h node1 -nc /usr/src/rell/config/node-config.properties -p 9870 -pk 03C3459ED2DC54F6C66DF24A0192743137AF66AC77EC6D003D3B88CD2184E68BF5
